$(document).ready(function () {
  ...
  $(function () {
    ...
    data.logoSrc = $templateData.data('') || '/oauth/static/main/img/logo.svg';
  ...
  $(".login-form-item-with-help a").click(function (e) {
    window.location.href = '/oauth/public/main/password_modify.html';
  });
